        ...
        <div id="layoutSidenav_content" class="bg-white text-dark">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4">Informasi Ruangan Tujuan</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="../../index.php" class="text-decoration-none">Dashboard</a></li>
                        <li class="breadcrumb-item active">Data Master</li>
                        <li class="breadcrumb-item active">Data Ruangan Tujuan</li>
                        <li class="breadcrumb-item active">Info Ruangan Tujuan>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-header font-weight-bold">
                            Data Ruangan Tujuan : <?php echo $pecah['nama']; ?>
                        </div>
                        <div class="card-body">
                            <div class="">
                                <form class="ml-4" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group ">
                                        <a href="/data-master/ruangan-tujuan/tujuan_ubah.php?&id_ruangan=<?php echo $pecah['id_ruangan']; ?>" class="btn-warning btn font-weight-bold px-3 mr-2 text-white"><i class="fas fa-edit"></i> Edit</a>
